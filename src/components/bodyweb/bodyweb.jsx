                    ...
                    <div className="overlay-intro-section" id="seccion-intro">
                        ...
                        <div className="Container-footer-intro">
                            <div className="Social-Media">
                                <a href="https://www.instagram.com/medeljoab/" target="_blank">
                                ...
                                <a href="https://github.com/JoabMedel" target="_blank">
                                ...
                                <a href="https://www.facebook.com/JoabMedel-artista-digital-101846844965777" target="_blank">
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" fill="currentColor" xmlSpace="preserve" className="color-icons-media">
                                ...
                                <a href="https://www.pinterest.com.mx/boiler_joab5555/" target="_blank">
                            ...
                            <div className="All-rights-reserved">©2021 Derechos Reservados Joab Medel.</div>
                        </div>
                    </div>
                </ParallaxBanner>
                        ...
                        <div className="cards-container-web" data-aos="zoom-in">
                            {
                                dataWebProjects.map((project,i)=>{
                                    return(
                                        <a href={project.link} target="_blank" key={project.tittle+i}>
                                            <CardAnimated 
                    ...
                    <div className="Contact-container" id="seccion-contacto">
                        ...
                        <div data-aos="fade-right">
                            ...
                            <div className="icons-container-contact">
                                <a href="https://wa.me/523322556776/" target="_blank" className="icon-fbmessenger">
                                    <IoLogoWhatsapp />
                                </a>
                            </div>
